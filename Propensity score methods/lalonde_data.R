...
#w.out2 <- weightit(treat ~ age + educ + hisp + 
#                    married + nodegr + re75 + u74 + u75, data = lalonde, estimand = "ATT", 
#                  method = "ps")
#summary(w.out2)
...
#design.w2 <- svydesign(~1, weights = w.out2$weights, data = lalonde)
#fit.w2 <- svyglm(re78 ~ treat + age + educ + hisp + 
#              married + nodegr + re75 + u74 + u75, 
#              design = design.w2)
#confint(fit.w2) 
